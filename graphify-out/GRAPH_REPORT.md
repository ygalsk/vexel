...
## Corpus Check
- 46 files · ~364,004 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 800 nodes · 1169 edges · 64 communities detected
...
6. `World` - 12 edges
7. `_run()` - 12 edges
8. `handle_submenu_input()` - 11 edges
9. `Phase 9: Codecritter Port (Overview)` - 11 edges
10. `ui/dungeon_screen.lua (Dungeon Exploration Scene)` - 11 edges
...
Cohesion: 0.25
Nodes (21): active_player(), add_msg(), begin_defeat_sequence(), begin_victory_sequence(), check_end_conditions(), enter_submenu(), exit_submenu(), find_next_alive() (+13 more)
...
Cohesion: 0.18
Nodes (5): Canvas, Core pxcli wrapper — Canvas context manager for the pxcli daemon., Run a pxcli command, return stdout., Context manager wrapping the pxcli daemon lifecycle.      Usage:         with Ca, _run()

### Community 15 - "Community 15"
Cohesion: 0.14
Nodes (17): circle(), copy_region(), ellipse(), _fill_circle_points(), _fill_ellipse_row(), mirror_h(), outline_rect(), _plot_circle_points() (+9 more)

### Community 16 - "Community 16"
Cohesion: 0.24
Nodes (9): M.col_px(), M.fill_cells(), M.info_panel(), M.menu_bar(), M.message_panel(), M.move_menu(), M.row_px(), M.submenu_list() (+1 more)
...
Cohesion: 0.33
Nodes (5): get_palette(), ramp(), Codecritter type palettes — 7 types, 6 colors each., Return palette dict for a type. Raises KeyError if unknown., Return palette colors darkest-to-lightest (for shading reference).
...
## Knowledge Gaps
- **141 isolated node(s):** `Event`, `KeyEvent`, `Action`, `MouseEvent`, `Button` (+136 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 48`** (2 nodes): `build()`, `build.zig`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `M.choose_move()`, `ai.lua`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `M.get()`, `biomes.lua`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (2 nodes): `moves.lua`, `M.get()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (2 nodes): `species.lua`, `M.get()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (2 nodes): `types.lua`, `M.effectiveness()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (2 nodes): `Pixel Compositor (RGBA Layer Stack)`, `Rationale: Pixel Compositor over Sub-cell Rendering`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (2 nodes): `ECS Components (Position/Velocity/Sprite/Animation)`, `ECS World (spawn/despawn/query)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (2 nodes): `timer.zig — Timer/Tween System`, `Lua Timers & Tweens API`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (2 nodes): `Gamepad Abstraction (keyboard-mapped)`, `Lua Input API (key/mouse/gamepad)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (1 nodes): `UX Principles (Apple HIG + Nielsen)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `v1 Scope Boundary`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `Hello World Test Game`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Bounce Test Game`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `Sprites Test Game (Gothic Castle)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (1 nodes): `Lua Graphics API Phase 1 (pixel drawing)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
